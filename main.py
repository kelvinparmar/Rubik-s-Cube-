    ...
    def update_solve(self):
        ...
        if self.solve_status and self.sollution != []:
            ...
            if self.sollution[0] == "U":
                ...
                self.green_side[0], self.green_side[1], self.green_side[2] = self.red_side[0], self.red_side[1], \
                    self.red_side[2]
                self.red_side[0], self.red_side[1], self.red_side[2] = self.blue_side[0], self.blue_side[1], \
                    self.blue_side[2]
                self.blue_side[0], self.blue_side[1], self.blue_side[2] = self.orange_side[0], self.orange_side[1], \
                    self.orange_side[2]
                self.orange_side[0], self.orange_side[1], self.orange_side[2] = temp1[0], temp1[1], temp1[2]
                temp2 = self.white_side
                self.white_side = [temp2[6], temp2[3], temp2[0], temp2[7], temp2[4], temp2[1], temp2[8], temp2[5],
                                   temp2[2]]
                self.update_grid_status()
                ...
                self.green_side[0], self.green_side[1], self.green_side[2] = self.blue_side[0], self.blue_side[1], \
                    self.blue_side[2]
                self.red_side[0], self.red_side[1], self.red_side[2] = self.orange_side[0], self.orange_side[1], \
                    self.orange_side[2]
                ...
                self.white_side = [temp3[8], temp3[7], temp3[6], temp3[5], temp3[4], temp3[3], temp3[2], temp3[1],
                                   temp3[0]]
                self.update_grid_status()
                ...
                self.panel.place(x=1000, y=450, in_=self.root)
                temp1 = [self.green_side[0], self.green_side[1], self.green_side[2]]
                self.green_side[0], self.green_side[1], self.green_side[2] = self.orange_side[0], self.orange_side[1], \
                    self.orange_side[2]
                self.orange_side[0], self.orange_side[1], self.orange_side[2] = self.blue_side[0], self.blue_side[1], \
                    self.blue_side[2]
                self.blue_side[0], self.blue_side[1], self.blue_side[2] = self.red_side[0], self.red_side[1], \
                    self.red_side[2]
                self.red_side[0], self.red_side[1], self.red_side[2] = temp1[0], temp1[1], temp1[2]
                temp2 = self.white_side
                self.white_side = [temp2[2], temp2[5], temp2[8], temp2[1], temp2[4], temp2[7], temp2[0], temp2[3],
                                   temp2[6]]
                self.update_grid_status()
                ...
                self.green_side[2], self.green_side[5], self.green_side[8] = self.yellow_side[2], self.yellow_side[5], \
                    self.yellow_side[8]
                self.yellow_side[2], self.yellow_side[5], self.yellow_side[8] = self.blue_side[6], self.blue_side[3], \
                    self.blue_side[0]
                self.blue_side[6], self.blue_side[3], self.blue_side[0] = self.white_side[2], self.white_side[5], \
                    self.white_side[8]
                self.white_side[2], self.white_side[5], self.white_side[8] = temp1[0], temp1[1], temp1[2]
                temp2 = self.red_side
                self.red_side = [temp2[6], temp2[3], temp2[0], temp2[7], temp2[4], temp2[1], temp2[8], temp2[5],
                                 temp2[2]]
                self.update_grid_status()
                ...
                self.green_side[2], self.green_side[5], self.green_side[8] = self.blue_side[6], self.blue_side[3], \
                    self.blue_side[0]
                self.white_side[2], self.white_side[5], self.white_side[8] = self.yellow_side[2], self.yellow_side[5], \
                    self.yellow_side[8]
                ...
                temp3 = self.red_side
                self.red_side = [temp3[8], temp3[7], temp3[6], temp3[5], temp3[4], temp3[3], temp3[2], temp3[1],
                                 temp3[0]]
                self.update_grid_status()
                ...
                temp1 = [self.green_side[2], self.green_side[5], self.green_side[8]]
                self.green_side[2], self.green_side[5], self.green_side[8] = self.white_side[2], self.white_side[5], \
                    self.white_side[8]
                self.white_side[2], self.white_side[5], self.white_side[8] = self.blue_side[6], self.blue_side[3], \
                    self.blue_side[0]
                self.blue_side[6], self.blue_side[3], self.blue_side[0] = self.yellow_side[2], self.yellow_side[5], \
                    self.yellow_side[8]
                self.yellow_side[2], self.yellow_side[5], self.yellow_side[8] = temp1[0], temp1[1], temp1[2]
                temp2 = self.red_side
                self.red_side = [temp2[2], temp2[5], temp2[8], temp2[1], temp2[4], temp2[7], temp2[0], temp2[3],
                                 temp2[6]]
                self.update_grid_status()
                ...
                self.green_side[0], self.green_side[3], self.green_side[6] = self.white_side[0], self.white_side[3], \
                    self.white_side[6]
                self.white_side[0], self.white_side[3], self.white_side[6] = self.blue_side[8], self.blue_side[5], \
                    self.blue_side[2]
                self.blue_side[8], self.blue_side[5], self.blue_side[2] = self.yellow_side[0], self.yellow_side[3], \
                    self.yellow_side[6]
                self.yellow_side[0], self.yellow_side[3], self.yellow_side[6] = temp1[0], temp1[1], temp1[2]
                temp2 = self.orange_side
                self.orange_side = [temp2[6], temp2[3], temp2[0], temp2[7], temp2[4], temp2[1], temp2[8], temp2[5],
                                    temp2[2]]
                self.update_grid_status()
                ...
                self.green_side[0], self.green_side[3], self.green_side[6] = self.blue_side[8], self.blue_side[5], \
                    self.blue_side[2]
                self.white_side[0], self.white_side[3], self.white_side[6] = self.yellow_side[0], self.yellow_side[3], \
                    self.yellow_side[6]
                ...
                self.orange_side = [temp3[8], temp3[7], temp3[6], temp3[5], temp3[4], temp3[3], temp3[2], temp3[1],
                                    temp3[0]]
                self.update_grid_status()
                ...
                temp1 = [self.green_side[0], self.green_side[3], self.green_side[6]]
                self.green_side[0], self.green_side[3], self.green_side[6] = self.yellow_side[0], self.yellow_side[3], \
                    self.yellow_side[6]
                self.yellow_side[0], self.yellow_side[3], self.yellow_side[6] = self.blue_side[8], self.blue_side[5], \
                    self.blue_side[2]
                self.blue_side[8], self.blue_side[5], self.blue_side[2] = self.white_side[0], self.white_side[3], \
                    self.white_side[6]
                self.white_side[0], self.white_side[3], self.white_side[6] = temp1[0], temp1[1], temp1[2]
                temp2 = self.orange_side
                self.orange_side = [temp2[2], temp2[5], temp2[8], temp2[1], temp2[4], temp2[7], temp2[0], temp2[3],
                                    temp2[6]]
                self.update_grid_status()
                ...
                self.white_side[2], self.white_side[1], self.white_side[0] = self.red_side[8], self.red_side[5], \
                    self.red_side[2]
                self.red_side[8], self.red_side[5], self.red_side[2] = self.yellow_side[6], self.yellow_side[7], \
                    self.yellow_side[8]
                self.yellow_side[6], self.yellow_side[7], self.yellow_side[8] = self.orange_side[0], self.orange_side[
                    3], self.orange_side[6]
                self.orange_side[0], self.orange_side[3], self.orange_side[6] = temp1[0], temp1[1], temp1[2]
                temp2 = self.blue_side
                self.blue_side = [temp2[6], temp2[3], temp2[0], temp2[7], temp2[4], temp2[1], temp2[8], temp2[5],
                                  temp2[2]]
                self.update_grid_status()
                ...
                self.white_side[2], self.white_side[1], self.white_side[0] = self.yellow_side[6], self.yellow_side[7], \
                    self.yellow_side[8]
                self.red_side[8], self.red_side[5], self.red_side[2] = self.orange_side[0], self.orange_side[3], \
                    self.orange_side[6]
                ...
                self.blue_side = [temp3[8], temp3[7], temp3[6], temp3[5], temp3[4], temp3[3], temp3[2], temp3[1],
                                  temp3[0]]
                self.update_grid_status()
                ...
                temp1 = [self.white_side[2], self.white_side[1], self.white_side[0]]
                self.white_side[2], self.white_side[1], self.white_side[0] = self.orange_side[0], self.orange_side[3], \
                    self.orange_side[6]
                self.orange_side[0], self.orange_side[3], self.orange_side[6] = self.yellow_side[6], self.yellow_side[
                    7], self.yellow_side[8]
                self.yellow_side[6], self.yellow_side[7], self.yellow_side[8] = self.red_side[8], self.red_side[5], \
                    self.red_side[2]
                self.red_side[8], self.red_side[5], self.red_side[2] = temp1[0], temp1[1], temp1[2]
                temp2 = self.blue_side
                self.blue_side = [temp2[2], temp2[5], temp2[8], temp2[1], temp2[4], temp2[7], temp2[0], temp2[3],
                                  temp2[6]]
                self.update_grid_status()
                ...
                self.white_side[6], self.white_side[7], self.white_side[8] = self.orange_side[8], self.orange_side[5], \
                    self.orange_side[2]
                self.orange_side[8], self.orange_side[5], self.orange_side[2] = self.yellow_side[2], self.yellow_side[
                    1], self.yellow_side[0]
                self.yellow_side[2], self.yellow_side[1], self.yellow_side[0] = self.red_side[0], self.red_side[3], \
                    self.red_side[6]
                self.red_side[0], self.red_side[3], self.red_side[6] = temp1[0], temp1[1], temp1[2]
                temp2 = self.green_side
                self.green_side = [temp2[6], temp2[3], temp2[0], temp2[7], temp2[4], temp2[1], temp2[8], temp2[5],
                                   temp2[2]]
                self.update_grid_status()
                ...
                self.white_side[6], self.white_side[7], self.white_side[8] = self.yellow_side[2], self.yellow_side[1], \
                    self.yellow_side[0]
                self.red_side[0], self.red_side[3], self.red_side[6] = self.orange_side[8], self.orange_side[5], \
                    self.orange_side[2]
                ...
                self.green_side = [temp3[8], temp3[7], temp3[6], temp3[5], temp3[4], temp3[3], temp3[2], temp3[1],
                                   temp3[0]]
                self.update_grid_status()
                ...
                temp1 = [self.white_side[6], self.white_side[7], self.white_side[8]]
                self.white_side[6], self.white_side[7], self.white_side[8] = self.red_side[0], self.red_side[3], \
                    self.red_side[6]
                self.red_side[0], self.red_side[3], self.red_side[6] = self.yellow_side[2], self.yellow_side[1], \
                    self.yellow_side[0]
                self.yellow_side[2], self.yellow_side[1], self.yellow_side[0] = self.orange_side[8], self.orange_side[
                    5], self.orange_side[2]
                self.orange_side[8], self.orange_side[5], self.orange_side[2] = temp1[0], temp1[1], temp1[2]
                temp2 = self.green_side
                self.green_side = [temp2[2], temp2[5], temp2[8], temp2[1], temp2[4], temp2[7], temp2[0], temp2[3],
                                   temp2[6]]
                self.update_grid_status()
                ...
                self.green_side[6], self.green_side[7], self.green_side[8] = self.orange_side[6], self.orange_side[7], \
                    self.orange_side[8]
                self.orange_side[6], self.orange_side[7], self.orange_side[8] = self.blue_side[6], self.blue_side[7], \
                    self.blue_side[8]
                self.blue_side[6], self.blue_side[7], self.blue_side[8] = self.red_side[6], self.red_side[7], \
                    self.red_side[8]
                self.red_side[6], self.red_side[7], self.red_side[8] = temp1[0], temp1[1], temp1[2]
                temp2 = self.yellow_side
                self.yellow_side = [temp2[6], temp2[3], temp2[0], temp2[7], temp2[4], temp2[1], temp2[8], temp2[5],
                                    temp2[2]]
                self.update_grid_status()
                ...
                self.green_side[6], self.green_side[7], self.green_side[8] = self.blue_side[6], self.blue_side[7], \
                    self.blue_side[8]
                self.red_side[6], self.red_side[7], self.red_side[8] = self.orange_side[6], self.orange_side[7], \
                    self.orange_side[8]
                ...
                self.yellow_side = [temp3[8], temp3[7], temp3[6], temp3[5], temp3[4], temp3[3], temp3[2], temp3[1],
                                    temp3[0]]
                self.update_grid_status()
                ...
                temp1 = [self.green_side[6], self.green_side[7], self.green_side[8]]
                self.green_side[6], self.green_side[7], self.green_side[8] = self.red_side[6], self.red_side[7], \
                    self.red_side[8]
                self.red_side[6], self.red_side[7], self.red_side[8] = self.blue_side[6], self.blue_side[7], \
                    self.blue_side[8]
                self.blue_side[6], self.blue_side[7], self.blue_side[8] = self.orange_side[6], self.orange_side[7], \
                    self.orange_side[8]
                self.orange_side[6], self.orange_side[7], self.orange_side[8] = temp1[0], temp1[1], temp1[2]
                temp2 = self.yellow_side
                self.yellow_side = [temp2[2], temp2[5], temp2[8], temp2[1], temp2[4], temp2[7], temp2[0], temp2[3],
                                    temp2[6]]
                self.update_grid_status()
